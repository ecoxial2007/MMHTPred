...
def main():
    ...
    args.meta_file = f'./data/Annotations'

    test_dataset = H5Dataset('test_ext', args)
    ...
    with torch.no_grad():
        ...
        with open(os.path.join(model_save_path, f'test_result.json'), 'w') as jsonf:
        ...
        plt.savefig(join(model_save_path, f'test_auc{roc_auc:.6f}.png'))
